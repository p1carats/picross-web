<div id="tutorial">
  ...
  <section class="story">
    ...
    <div class="imagetuto">
      ...
      <figure>
        <img src="assets/img/picrossFINI.png" alt="Picture of a puzzle finished"></img>
    ...
    <div class="imagetuto">
      <figure>
        <img src="assets/img/example1.png" alt="One way of solving the line"></img>
        <figcaption>One possibility of solving the line</figcaption>
      </figure>
      <figure>
        <img src="assets/img/example2.png" alt="Another way of solving the same line"></img>
